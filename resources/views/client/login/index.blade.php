...
<body class="w-full h-screen bg-no-repeat bg-cover" style="background-image: url({{ asset('assets/img/bg3.png') }})">
    <div class="grid lg:grid-cols-2 grid-rows-none">
        <div class="visible grid lg:grid-cols-3 lg:visible sm:invisible md:invisible xs:invisible ssm:invisible sxm:invisible xxm:invisible">
            <div class="xl:col-span-3 lg:col-span-3 lg:bg-no-repeat lg:h-screen w-full bg-cover" style="background-image: url({{ asset('assets/img/logintheme2.png') }})"></div>
        </div>
            ...
            <div class="w-full lg:max-w-lg">
                <div class="p-6 space-y-5 md:space-y-6 sm:p-8">
                    ...
                    <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl ">
                        <a class="text-gray-500">Sign </a><a class="text-blue-400">in</a>
                    </h1>
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('client.login.process') }}" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="text-sm font-medium text-primary-600 hover:underline text-blue-500">
                                Forgot password?
                            </a>
                        </div>
                        <button class="px-4 py-2 w-full text-lg font-semibold text-sm bg-blue-500 text-white rounded-none shadow-sm" type="submit" name="Submit">Sign In</button>
                    </form>

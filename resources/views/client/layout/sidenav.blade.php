        ...
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                @if (Route::is('client.dashboard'))
                    ...
                    @else
                        <a href="{{ route('client.dashboard') }}" class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="#">
                @endif
            ...
            <li class="mt-0.5 w-full">
                @if (Route::is('client.devices'))
                    <a class="py-2.7 bg-blue-500/13 dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors" href="#">
                    @else
                        <a href="{{ route('client.devices') }}" class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="#">
                @endif
                <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                    <i class="relative top-0 text-sm leading-normal text-blue-500 fas fa-lightbulb"></i>
                </div>
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Devices</span>
                </a>
